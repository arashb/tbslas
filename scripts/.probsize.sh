...
ibrun -n 32 -o 0 tacc_affinity /home/03237/ga29hoj/code/tbslas/examples/bin/advdiff-ss -N 512 -tol ${tol} -q ${q} -d 15 -dt 0.00625 -tn ${TN} -test ${TEST} -omp 20 -merge 3 -diff 1e-3 -adap 0 -vsr 0 -m 8 -ea ${a} > max_oct_${TEST}_${a}_tn${TN}.out
