...
void modified_laplace_poten(Real_t *r_src, int src_cnt, Real_t *v_src, int dof,
...
const pvfmm::Kernel<double> modified_laplace_potn_d =
    pvfmm::BuildKernel<double, modified_laplace_poten>(
        GetModfiedLaplaceKernelName(TBSLAS_ALPHA), 3,
...
template <>
const pvfmm::Kernel<double> &ModifiedLaplaceKernel<double>::potn_ker() {
