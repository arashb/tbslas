...
template <class Real_t>
void RunModStokesSolver(int test_case, size_t N, size_t M, bool unif,
                        int mult_order, int cheb_deg, int depth, bool adap,
                        Real_t tol, MPI_Comm comm) {
...
int main(int argc, char** argv) {
  ...
  RunModStokesSolver<double>(test, sim_config->tree_num_point_sources,
