...
int main(int argc, char** argv) {
...

  {
    ...
    tbslas::ConstructTree<Tree_t>(
        ...
        sim_config->tree_adap, sim_config->tree_tolerance, comm,
        get_gaussian_field_cylinder_atT<double, 3>, 1, tree);
    // =========================================================================
    // COMPUTE ERROR
    // =========================================================================
    double rli, rl2;
    double ali, al2;
    CheckChebOutput<Tree_t>(&tree, get_gaussian_field_cylinder_atT<double, 3>,
                            1, al2, rl2, ali, rli, std::string("Output"));

    std::vector<double> grid_points;
    std::vector<double> node_pos =
        pvfmm::cheb_nodes<double>(sim_config->tree_chebyshev_order, 3);
