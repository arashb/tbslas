...
void fmm_test(int ker, size_t N, size_t M, Real_t b, int dist, int mult_order, int depth, MPI_Comm comm){
  ...
  const pvfmm::Kernel<double> modified_laplace_kernel_d = pvfmm::BuildKernel<double, tbslas::modified_laplace_poten>
  ...
  const pvfmm::Kernel<double> modified_stokes_vel = pvfmm::BuildKernel<double, tbslas::modified_stokes_vel>
